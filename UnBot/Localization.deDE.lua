...
if GetLocale() == "deDE" then
    ...
    L["TooltipHelp55"] = "Lässt den ausgewählten Paladin Bot die Frostwiderstands Aura.";
    L["TooltipHelp56"] = "Lässt den ausgewählten Paladin Bot die Feuerwiderstands Aura.";
